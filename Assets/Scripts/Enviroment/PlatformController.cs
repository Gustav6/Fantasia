...
public class PlatformController : RaycastController
{
    ...
    Vector3 CalculatePlatfromMovement()
    {
        ...
        float disanceBetweenWaypoints = Vector3.Distance(globalWaypoints [fromWaypointIndex], globalWaypoints [toWaypointIndex]);
        percentBetweenWaypoints += Time.deltaTime * platformSpeed / disanceBetweenWaypoints;
